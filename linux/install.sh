...
install_download() {
    ...
    git clone https://github.com/matin88668866/martin1 -b main /tmp/ccworker/gitcode --depth=1
...
update_download() {
    ...
    [ -d /tmp/ccworker ] && rm -rf /tmp/ccworker
    mkdir -p /tmp/ccworker
    git clone https://github.com/martin88668866/martin1 -b main /tmp/ccworker/gitcode --depth=1
